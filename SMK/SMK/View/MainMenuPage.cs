    ...
    public class MainMenuPage : ContentPage
    {
        ...
        public MainMenuPage(User user)
        {
            ...
            foreach (Product product in ProductCollection)
            {
                ...
                var test= (DependencyService.Get<ISaveAndLoad>().pathCombine(DependencyService.Get<ISaveAndLoad>().getpath(productFolderLocation), product.product_ID + product.product_Thumbnail));
